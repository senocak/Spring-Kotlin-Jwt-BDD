...
class UserJsonTest {
    ...
    private val person: User = User(name = "anil", username = "asenocak", email = "anil@senocak.com", password = "password")
    ...
    @Test
    fun deserializeJson() {
        val dtoString = "{\"name\":\"anil\",\"username\":\"asenocak\",\"email\":\"anil@senocak.com\",\"password\":\"password\",\"roles\":[],\"id\":null,\"createdAt\":\"2022-12-19T11:09:55.150+00:00\",\"updatedAt\":\"2022-12-19T11:09:55.150+00:00\"}";
        val dto: User = jackson.parseObject(dtoString)
        assertThat(dto.id).isNull()
        assertThat(dto.name).isEqualTo("anil")
        //assertEquals("anil", dto.name);
        assertThat(dto.username).isEqualTo("asenocak")
