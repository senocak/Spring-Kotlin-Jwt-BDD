...
import com.github.senocak.boilerplate.config.AppProperties
...
class JwtTokenProvider(
     ...
     */
    fun getSubjectFromJWT(token: String): String = getJwsClaims(token = token).payload!!.subject
    ...
    /**
     * Decodes the Base64-encoded JWT secret and returns a SecretKey for HMAC SHA-256 signing.
     *
     * @return SecretKey used for JWT signature verification.
     */
