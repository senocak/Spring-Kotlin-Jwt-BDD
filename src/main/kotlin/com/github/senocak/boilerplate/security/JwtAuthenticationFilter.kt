...
import com.github.senocak.boilerplate.util.AppConstants.TOKEN_HEADER_NAME
import com.github.senocak.boilerplate.util.AppConstants.TOKEN_PREFIX
...
class JwtAuthenticationFilter(
    ...
    override fun doFilterInternal(request: HttpServletRequest, response: HttpServletResponse, filterChain: FilterChain) {
        try {
            ...
            log.error("Could not set user authentication in security context. Error: ${ex.localizedMessage}")
            return
        }
