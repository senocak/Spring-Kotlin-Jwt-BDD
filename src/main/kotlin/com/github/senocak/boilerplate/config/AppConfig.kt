...
import com.github.senocak.boilerplate.security.AuthorizationInterceptor
import com.github.senocak.boilerplate.util.AppConstants
import com.github.senocak.boilerplate.util.AppConstants.corePoolSize
...
@EnableAsync
@Configuration
class AppConfig(private val authorizationInterceptor: AuthorizationInterceptor): WebServerFactoryCustomizer<TomcatServletWebServerFactory>, WebMvcConfigurer {
    ...
    @Bean
    fun customOpenAPI(@Value("\${springdoc.api-docs.version}") appVersion: String?): OpenAPI? {
